...
# Duty
# Develop a machine learning model that predicts house prices with minimum error from the data set we have and upload your predictions to the kaggle competition.
...
################################################ ##############
# Step 1: Read and merge the Train and Test datasets. Progress through the data you have merged.
################################################ ##############

# Combination of train and test sets.
train = pd.read_csv("8.Hafta/House_prediction/HousePrice/data/train.csv")
test = pd.read_csv("8.Hafta/House_prediction/HousePrice/data/test.csv")
...
# This function fills missing values with median or mean
...
######################################
# Create new variables and add 'NEW' to the beginning of the new variables you created.
######################################
...
# Separation of Train and Test data. (Values with an empty SalePrice variable are test data.)
...
##################
# Establishing a model by performing log transformation and observing rmse results.
...
################################################ ##############
# Plotting the order of features using the feature_importance function, which specifies the importance of the variables
################################################ ##############
